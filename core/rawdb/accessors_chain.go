...
func WriteLastPivotNumber(db ethdb.KeyValueWriter, pivot uint64) {
	...
	if err != nil {
		log.Error("Failed to encode pivot block number", "err", err)
	}
	if err := db.Put(lastPivotKey, enc); err != nil {
		log.Error("Failed to store pivot block number", "err", err)
	}
}
...
func WriteTxIndexTail(db ethdb.KeyValueWriter, number uint64) {
	if err := db.Put(txIndexTailKey, encodeBlockNumber(number)); err != nil {
		log.Error("Failed to store the transaction index tail", "err", err)
	}
}
...
func WriteFastTxLookupLimit(db ethdb.KeyValueWriter, number uint64) {
	if err := db.Put(fastTxLookupLimitKey, encodeBlockNumber(number)); err != nil {
		log.Error("Failed to store transaction lookup limit for fast sync", "err", err)
	}
}
...
func WritePbCacheBody(db ethdb.KeyValueWriter, hash common.Hash, body *types.Body) {
	...
	if err := db.Put(pbBodyKey(hash), data); err != nil {
		log.Error("Failed to write pbBodyKey", "err", err)
	}
}
...
func DeletePbCacheBody(db ethdb.KeyValueWriter, hash common.Hash) {
	if err := db.Delete(pbBodyKey(hash)); err != nil {
		log.Error("Failed to delete pb cache body", "err", err)
	}
}
...
func WritePbBodyKeys(db ethdb.KeyValueWriter, hashes []common.Hash) {
	...
	if err != nil {
		log.Error("Failed to RLP encode pending block body keys", "err", err)
	}
	if err := db.Put(key, data); err != nil {
		log.Error("Failed to store pending block body keys", "err", err)
	}
}
...
func DeletePbBodyKeys(db ethdb.KeyValueWriter, hash common.Hash) {
	...
	if err := db.Delete(key); err != nil {
		log.Error("Failed to delete pending block body keys", "err", err)
	}
}
...
func WriteTermini(db ethdb.KeyValueWriter, index common.Hash, hashes []common.Hash) {
	...
	data, err := rlp.EncodeToBytes(hashes)
	if err != nil {
		log.Error("Failed to RLP encode termini", "err", err)
	}
	if err := db.Put(key, data); err != nil {
		log.Error("Failed to store last block's termini", "err", err)
	}
}
...
func DeleteTermini(db ethdb.KeyValueWriter, hash common.Hash) {
	...
	if err := db.Delete(key); err != nil {
		log.Error("Failed to delete termini ", "err", err)
	}
}
...
func WritePendingHeader(db ethdb.KeyValueWriter, hash common.Hash, pendingHeader *types.Header) {
	...
	if err != nil {
		log.Error("Failed to RLP encode pending header", "err", err)
	}
...
func DeletePendingHeader(db ethdb.KeyValueWriter, hash common.Hash) {
	key := pendingHeaderKey(hash)
	if err := db.Delete(key); err != nil {
		log.Error("Failed to delete slice pending header ", "err", err)
	}
}
...
func WritePhCacheEntropy(db ethdb.KeyValueWriter, hash common.Hash, s *big.Int) {
	...
	if err != nil {
		log.Error("Failed to RLP encode ph cache entropy", "err", err)
	}
	if err := db.Put(phCacheEntropyKey(hash), data); err != nil {
		log.Error("Failed to store ph cache entropy", "err", err)
	}
}
...
func DeletePhCache(db ethdb.KeyValueWriter) {
	if err := db.Delete(phCacheKey); err != nil {
		log.Error("Failed to delete ph cache", "err", err)
	}
}
...
func WriteBestPhKey(db ethdb.KeyValueWriter, bestPhKey common.Hash) {
	...
	if err != nil {
		log.Error("Failed to RLP encode write best ph key", "err", err)
	}
...
func DeleteBestPhKey(db ethdb.KeyValueWriter) {
	if err := db.Delete(phHeadKey); err != nil {
		log.Error("Failed to delete ph head", "err", err)
	}
}
...
func WriteBadBlock(db ethdb.KeyValueStore, block *types.Block) {
	...
	if len(blob) > 0 {
		if err := rlp.DecodeBytes(blob, &badBlocks); err != nil {
			log.Error("Failed to decode old bad blocks", "error", err)
		}
	}
	...
	if err != nil {
		log.Error("Failed to encode bad blocks", "err", err)
	}
	if err := db.Put(badBlockKey, data); err != nil {
		log.Error("Failed to write bad blocks", "err", err)
	}
}
...
func DeleteBadBlocks(db ethdb.KeyValueWriter) {
	if err := db.Delete(badBlockKey); err != nil {
		log.Error("Failed to delete bad blocks", "err", err)
	}
}
...
func WriteEtxSetRLP(db ethdb.KeyValueWriter, hash common.Hash, number uint64, rlp rlp.RawValue) {
	if err := db.Put(etxSetKey(number, hash), rlp); err != nil {
		log.Error("Failed to store etx set", "err", err)
	}
}
...
func WriteEtxSet(db ethdb.KeyValueWriter, hash common.Hash, number uint64, etxSet types.EtxSet) {
	...
	if err != nil {
		log.Error("Failed to RLP encode etx set", "err", err)
	}
...
func DeleteEtxSet(db ethdb.KeyValueWriter, hash common.Hash, number uint64) {
	if err := db.Delete(etxSetKey(number, hash)); err != nil {
		log.Error("Failed to delete etx set", "err", err)
	}
}
...
func WritePendingEtxsRLP(db ethdb.KeyValueWriter, hash common.Hash, rlp rlp.RawValue) {
	if err := db.Put(pendingEtxsKey(hash), rlp); err != nil {
		log.Error("Failed to store pending etxs", "err", err)
	}
}
...
func WritePendingEtxs(db ethdb.KeyValueWriter, pendingEtxs types.PendingEtxs) {
	...
	if err != nil {
		log.Error("Failed to RLP encode pending etxs", "err", err)
	}
...
func DeletePendingEtxs(db ethdb.KeyValueWriter, hash common.Hash, number uint64) {
	if err := db.Delete(pendingEtxsKey(hash)); err != nil {
		log.Error("Failed to delete pending etxs", "err", err)
	}
}
...
func WritePendingEtxsRollup(db ethdb.KeyValueWriter, pendingEtxsRollup types.PendingEtxsRollup) {
	...
	if err != nil {
		log.Error("Failed to RLP encode pending etxs rollup", "err", err)
	}
	if err := db.Put(pendingEtxsRollupKey(pendingEtxsRollup.Header.Hash()), data); err != nil {
		log.Error("Failed to store pending etxs rollup", "err", err)
	}
}
...
func DeletePendingEtxsRollup(db ethdb.KeyValueWriter, hash common.Hash) {
	if err := db.Delete(pendingEtxsRollupKey(hash)); err != nil {
		log.Error("Failed to delete pending etxs rollup", "err", err)
	}
}
