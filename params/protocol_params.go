...
var (
	...
	BlocksPerDay               uint64 = new(big.Int).Div(big.NewInt(10), DurationLimit).Uint64() // BlocksPerDay is the number of blocks per day assuming 5 second block time
	...
	ControllerKickInBlock                uint64 = (70000000000 * BlocksPerWeek) / 4 // This is in order of prime blocks
	CoinbaseLockupPrecompileKickInHeight        = 500000000000000 * BlocksPerWeek   // The height at which the coinbase lockup precompile is enabled
